    ...
    <div class="conteudo">
      ...
      <div class="cards">
        ...
        <div class="card animate-fade-in delay-200">
          ...
          <p class="card-texto">
            Os atiradores participam de instruções militares, educação física, palestras formativas, eventos cívicos e ações sociais que visam o bem-estar da comunidade.
          </p>
        </div>
      </div>
